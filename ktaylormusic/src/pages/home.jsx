...
export default function Home() {
  ...
  return (
    <main className="flex flex-col justify-center items-center bg-black text-white">
      <div className="desktop:hidden flex justify-center relative mb-4">
        ...
        <div className="img-text absolute top-[17%] left=[50%] tablet:hidden w-[100vw]">
          <h1 className="text-4xl text-center text-white font-ewert">
            Kolten Taylor
            <br />
            <span className="text-2xl font-caveat">& the Truck Toppers</span>
          </h1>
      ...
      <About />
      {/* YOUTUBE VIDEO */}
      <div className="video-container desktop:hidden mx-10 mb-10 pb-10">
        <iframe
          className="w-[85vw]"
      ...
      {/* SHOWS / CONTACT */}
      <section className="w-[100vw] flex flex-col desktop:flex-row items-center justify-center desktop:justify-center">
        <Shows />
        <Contact />
      </section>
    </main>
